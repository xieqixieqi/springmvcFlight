...
<div class=" clearfix" id="advertising">
  ...
  <div class="Ads_list">
    <iframe id="iframe"  scrolling="auto" style="border:0; min-height:740px;width:100%;background-color:#FFF;"name="iframe" frameborder="0"  src="Statistics/echart1.jsp"	> </iframe>
  </div>
</div>
</body>
</html>
